...
public class ComplianceReportingService {
  ...
  private Map<String, Object> getDataProcessingActivities(UUID tenantId, LocalDateTime startDate,
  ...
  private Map<String, Object> getDataRetentionCompliance(UUID tenantId, LocalDateTime startDate,
      LocalDateTime endDate) {
  ...
  private Map<String, Object> getConfidentialityMeasures(UUID tenantId, LocalDateTime startDate,
      LocalDateTime endDate) {
  ...
  private Map<String, Object> getAdministrativeSafeguards(UUID tenantId, LocalDateTime startDate,
      LocalDateTime endDate) {
