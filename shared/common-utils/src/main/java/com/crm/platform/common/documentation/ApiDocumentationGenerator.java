...
public class ApiDocumentationGenerator {
  ...
  private void addSuccessResponseExamples() {
    ...
    data.put("phone", "+1-555-123-4567");
    data.put("company", "Acme Corporation");
    data.put("title", "Software Engineer");
    data.put("status", "ACTIVE");
    data.put("leadScore", 85);
    data.put("tags", java.util.List.of("prospect", "enterprise"));
    data.put("customFields", Map.of("industry", "Technology", "budget", 50000));
    data.put("createdAt", "2024-01-24T10:30:00Z");
    data.put("updatedAt", "2024-01-24T15:45:00Z");

    Map<String, Object> meta = new HashMap<>();
    meta.put("timestamp", "2024-01-24T15:45:00Z");
    meta.put("version", "v1");
    meta.put("requestId", "req_123456789");
    meta.put("processingTime", "45ms");
  ...
  private void addBulkOperationExamples() {
    ...
    Map<String, Object> data = new HashMap<>();
    data.put("jobId", "bulk_123e4567-e89b-12d3-a456-426614174000");
    data.put("status", "PROCESSING");
    data.put("totalRecords", 1000);
    data.put("processedRecords", 250);
    data.put("successfulRecords", 240);
    data.put("failedRecords", 10);
    data.put("skippedRecords", 0);
    data.put("progress", 25.0);
    data.put("startedAt", "2024-01-24T15:30:00Z");
    data.put("estimatedTimeRemaining", 180);
    ...
    data.put("warnings", java.util.List.of(
        Map.of(
            "recordIndex", 23,
    ...
    bulkOperationExample.setValue(value);
