...
public abstract class BaseController<T, ID> {
    ...
    protected abstract BulkOperationResponse<T> bulkOperation(BulkOperationRequest<T> request);
    ...
    public ResponseEntity<com.crm.platform.common.dto.ApiResponse<List<T>>> getAll(
            ...
            @Parameter(description = "Sort criteria (field:direction)", example = "name:asc,createdAt:desc")
            ...
            @Parameter(description = "Related entities to include")
        ...
        com.crm.platform.common.dto.ApiResponse<List<T>> response = 
    ...
    public ResponseEntity<com.crm.platform.common.dto.ApiResponse<BulkOperationResponse<T>>> bulkOperation(
            ...
            @Valid @RequestBody BulkOperationRequest<T> request) {
        
        BulkOperationResponse<T> response = bulkOperation(request);
    ...
    public ResponseEntity<com.crm.platform.common.dto.ApiResponse<BulkOperationResponse<T>>> getBulkOperationStatus(
            @Parameter(description = "Bulk operation job ID", required = true)
    ...
    protected com.crm.platform.common.dto.ApiResponse<T> errorResponse(List<ErrorDetail> errors) {
        return com.crm.platform.common.dto.ApiResponse.error(errors);
    }
}