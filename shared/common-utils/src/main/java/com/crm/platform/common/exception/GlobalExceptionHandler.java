...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleEntityNotFound(
        ...
        List<ErrorDetail> errors = List.of(
                new ErrorDetail("ENTITY_NOT_FOUND", ex.getMessage(), null, null, null)
        );
    ...
    public ResponseEntity<ApiResponse<Object>> handleIllegalArgument(
        ...
        List<ErrorDetail> errors = List.of(
                new ErrorDetail("INVALID_ARGUMENT", ex.getMessage(), null, null, null)
        );
    ...
    public ResponseEntity<ApiResponse<Object>> handleMessageNotReadable(
        ...
        List<ErrorDetail> errors = List.of(
                new ErrorDetail("INVALID_REQUEST_BODY", "Invalid JSON format or missing required fields", null, null, null)
        );
    ...
    public ResponseEntity<ApiResponse<Object>> handleMethodNotSupported(
        ...
        List<ErrorDetail> errors = List.of(
                new ErrorDetail("METHOD_NOT_SUPPORTED", message, null, null, null)
        );
    ...
    public ResponseEntity<ApiResponse<Object>> handleMediaTypeNotSupported(
        ...
        List<ErrorDetail> errors = List.of(
                new ErrorDetail("MEDIA_TYPE_NOT_SUPPORTED", message, null, null, null)
        );
    ...
    public ResponseEntity<ApiResponse<Object>> handleNoHandlerFound(
        ...
        List<ErrorDetail> errors = List.of(
                new ErrorDetail("ENDPOINT_NOT_FOUND", message, null, null, null)
        );
    ...
    public ResponseEntity<ApiResponse<Object>> handleGenericException(
        ...
        List<ErrorDetail> errors = List.of(
                new ErrorDetail("INTERNAL_SERVER_ERROR", "An unexpected error occurred. Please try again later.", null, null, null)
        );
