...
class ApiResponseTest {
  ...
  void testErrorResponseWithDetails() {
    ErrorDetail errorDetail = new ErrorDetail("VALIDATION_ERROR", "Invalid field", "email", "invalid-email",
        "EMAIL_FORMAT");
    List<ErrorDetail> errors = List.of(errorDetail);
    ApiResponse<String> response = ApiResponse.errorWithDetails(errors);
